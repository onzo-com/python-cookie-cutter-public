...
import pytest
from {{cookiecutter.project_slug}}.analytics.{{cookiecutter.feature_name}}.tests.postgresql_resources.postgresql_test_infrastructure import postgresqlTestCase
